...
const routes: Routes = [
  ...
  {path: "auth", loadChildren: () => import('./components/page/auth/auth.module').then(m => m.AuthModule)}, {path: "profile", loadChildren: () => import('./components/page/profile/profile.module').then(m => m.ProfileModule)},
